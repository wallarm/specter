...
func TestDecodeHTTPConfigHeaders(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			assertions.EqualValues(tt.want.ans, ans)
			assertions.EqualValues(tt.want.err, err)
		})
	}
}
...
func TestEnrichRequestWithHeaders(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			assertions.EqualValues(tt.want.Host, req.Host)
			assertions.EqualValues(tt.want.Header, req.Header)
		})
	}
}
