...
// TODO: test decoder that fills ammo with random data
...
func (p *DecodeProvider) Run(ctx context.Context, deps core.ProviderDeps) (err error) {
	...
	// TODO:  Let's add optional Reset(io.Reader) method, that will allow efficient Decoder reset after every pass.
